...
class NewsWallsScreen extends StatefulWidget {
  const NewsWallsScreen({super.key});

  @override
  State<NewsWallsScreen> createState() => _NewsWallsScreenState();
}

class _NewsWallsScreenState extends State<NewsWallsScreen> {
                  ...
                  CustomElevatedButton(
                    ...
                    onPressed: () {
                      if (wideCtr.text.isNotEmpty) {
                        Get.to(() => const NewWallsResultScreen(), arguments: {
                          'wide': wideCtr.text,
                        });
                      }
                    },
