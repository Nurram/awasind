...
class OldWallsResultScreen extends StatefulWidget {
  const OldWallsResultScreen({super.key});

  @override
  State<OldWallsResultScreen> createState() => _OldWallsResultScreenState();
}

class _OldWallsResultScreenState extends State<OldWallsResultScreen> {
  ...
  _calculate() {
    ...
    basePaintVolume = wide * .12;
    basePaintPrice = basePaintVolume * 48000;
    paintVolume = wide * 0.18;
  ...
  _buildPdf() async {
    ...
    try {
      File file = File("/storage/emulated/0/Download/dinding_lama.pdf");
      await file.writeAsBytes(await pdf.save(), flush: true);

      Utils.showGetSnackbar(
          'File disimpan di: /storage/emulated/0/Download/dinding_lama.pdf',
          true);
    } catch (e) {
      log(e.toString());
    }
